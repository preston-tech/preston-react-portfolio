...
export default class BlogForm extends Component {
    ...
    handleSubmit(event) {
        axios.post("https://prestonphillips.devcamp.space/portfolio/portfolio_blogs",
        this.buildForm(),
        { withCredentials: true }
        )
        .then(response => {
            if (this.state.featured_image) {
                this.featuredImageRefs.current.dropzone.removeAllFiles()
            }
                this.setState({
                title: "",
                blog_status: "",
        ...
        return (
            <form onSubmit={this.handleSubmit} className="blog-form-wrapper">
                ...
                <input 
                    ...
                    value={this.state.title.blog_status}
                />
                </div>
